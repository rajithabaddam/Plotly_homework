  ...
  function createchart(sampleid){
    d3.json("samples.json").then(function(data) {
     ...
     console.log(otu_ids,otu_labels,sample_values);
      ...
      var samplevalueSort = sample_values.sort((a,b) => b - a).slice(0,10).reverse();
      var idSort = otu_ids.sort((a,b) => b - a).slice(0,10).reverse();
      var labelsSort = otu_labels.sort((a,b) => b - a).slice(0,10).reverse();
     // var samplevalueSort = result.sort((a,b) => b.sample_values - a.sample_values).slice(0,10).reverse();
